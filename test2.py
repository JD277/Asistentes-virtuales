...
class AsistenteGUI:
    def __init__(self, root):
        ...
        # Botones para métodos adicionales
        self.doc_button = tk.Button(self.button_frame, text="Crear Documento", command=self.crear_documento)
        self.doc_button.pack(side=tk.LEFT, padx=5)

        self.web_button = tk.Button(self.button_frame, text="Crear Proyecto Web", command=self.crear_proyecto_web)
        self.web_button.pack(side=tk.LEFT, padx=5)

        self.ppt_button = tk.Button(self.button_frame, text="Crear Presentación", command=self.crear_presentacion)
        self.ppt_button.pack(side=tk.LEFT, padx=5)

        self.note_button = tk.Button(self.button_frame, text="Escribir Nota", command=self.escribir_nota)
    ...
    def crear_documento(self):
        ...
        if tema:
            ...
            messagebox.showwarning("Advertencia", "Por favor, ingresa un tema para el documento.")

    def crear_proyecto_web(self):
        tema = self.entry.get()
        if tema:
            ...
            if nombre_proyecto and ruta_proyecto:
                ...
                messagebox.showwarning("Advertencia", "Debes proporcionar un nombre y una ruta para el proyecto.")
        else:
            messagebox.showwarning("Advertencia", "Por favor, ingresa un tema para el proyecto web.")
    ...
    def crear_presentacion(self):
        ...
        if tema:
            ...
            messagebox.showwarning("Advertencia", "Por favor, ingresa un tema para la presentación.")

    def escribir_nota(self):
        tema = self.entry.get()
        if tema:
            ...
            if directorio:
                ...
                if nombre_carpeta:
                    ...
                    messagebox.showwarning("Advertencia", "Debes proporcionar un nombre para la carpeta.")
            else:
                messagebox.showwarning("Advertencia", "Debes seleccionar una ruta para guardar la nota.")
        else:
            messagebox.showwarning("Advertencia", "Por favor, ingresa un tema para la nota.")
